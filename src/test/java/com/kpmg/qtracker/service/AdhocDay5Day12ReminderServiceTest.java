...
class AdhocDay5Day12ReminderServiceTest {
    ...
    void day5WithFacilitatorResponseUsesSubmitText() {
        ...
        when(notificationRepository.existsByControlIdAndTypeAndCreatedAtGreaterThanEqualAndCreatedAtLessThan(
                eq(71L),
                eq(AdhocDay5Day12ReminderService.TYPE_DAY5),
        ...
        assertThat(saved.getType()).isEqualTo(AdhocDay5Day12ReminderService.TYPE_DAY5);
        assertThat(saved.getTitle()).isEqualTo("Control reminder: CTRL-71");
    ...
    void day12WithoutResponseUsesCloseText() {
        ...
        when(notificationRepository.existsByControlIdAndTypeAndCreatedAtGreaterThanEqualAndCreatedAtLessThan(
                eq(72L),
                eq(AdhocDay5Day12ReminderService.TYPE_DAY12),
                any(LocalDateTime.class),
                any(LocalDateTime.class))).thenReturn(false);
        ...
        verify(notificationRepository).save(captor.capture());
        Notification saved = captor.getValue();
        assertThat(saved.getType()).isEqualTo(AdhocDay5Day12ReminderService.TYPE_DAY12);
        Control control = new Control();
